...
- Exposed CUPS & avahi config-files

### Restrictions
- Can announce but not discover printers using mDNS
- Only stock and brother printers are preinstalled
- No Ingress (yet?)
# Help
### Installation
...
- **More infos:** Are on [the repo add-on-page](https://github.com/Switch123456789/Switch-s-Home-Assistant-Add-ons)